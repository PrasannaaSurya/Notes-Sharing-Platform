  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        <h1 style={styles.title}><strong>UPLOAD FILES</strong></h1>
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.formGroup}>
            <label htmlFor="registerNumber"><strong>REGISTER NUMBER</strong></label>
            <input
              type="text"
              id="registerNumber"
              name="registerNumber"
          ...
          <div style={styles.formGroup}>
            <label htmlFor="image"><strong>IMAGES</strong></label>
            <input
              type="file"
              id="image"
              name="image"
